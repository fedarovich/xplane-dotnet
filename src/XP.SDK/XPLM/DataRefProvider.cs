...
{
    public abstract unsafe class DataRefSource : IDisposable
    {
        private GCHandle _handle;
        private DataRef _dataRef;
        private int _disposed;

        protected DataRefSource(in Utf8String name, DataTypeID dataTypes, bool isWriteable)
        {
        ...
        protected DataRefSource(in ReadOnlySpan<char> name, DataTypeID dataTypes, bool isWriteable)
        {
            _handle = GCHandle.Alloc(this);
            void* refcon = GCHandle.ToIntPtr(_handle).ToPointer();
        ...
        private static int GetDatai(void* inrefcon) =>
            Utils.TryGetObject<DataRefSource>(inrefcon)?.Int32Value ?? default;

        [UnmanagedCallersOnly]
        private static void SetDatai(void* inrefcon, int invalue)
        {
        ...
        [UnmanagedCallersOnly]
        private static float GetDataf(void* inrefcon) =>
            Utils.TryGetObject<DataRefSource>(inrefcon)?.SingleValue ?? default;

        [UnmanagedCallersOnly]
        private static void SetDataf(void* inrefcon, float invalue)
        {
            var obj = Utils.TryGetObject<DataRefSource>(inrefcon);
            if (obj != null)
            {
        ...
        [UnmanagedCallersOnly]
        private static double GetDatad(void* inrefcon) =>
            Utils.TryGetObject<DataRefSource>(inrefcon)?.DoubleValue ?? default;

        [UnmanagedCallersOnly]
        private static void SetDatad(void* inrefcon, double invalue)
        {
            var obj = Utils.TryGetObject<DataRefSource>(inrefcon);
            if (obj != null)
            {
        ...
        [UnmanagedCallersOnly]
        private static int GetDatavi(void* inrefcon, int* outvalues, int inoffset, int inmax)
        {
            var obj = Utils.TryGetObject<DataRefSource>(inrefcon);
            if (obj != null)
            {
        ...
        [UnmanagedCallersOnly]
        private static void SetDatavi(void* inrefcon, int* invalues, int inoffset, int incount)
        {
            var obj = Utils.TryGetObject<DataRefSource>(inrefcon);
            if (obj != null)
            {
        ...
        [UnmanagedCallersOnly]
        private static int GetDatavf(void* inrefcon, float* outvalues, int inoffset, int inmax)
        {
            var obj = Utils.TryGetObject<DataRefSource>(inrefcon);
            if (obj != null)
            {
        ...
        [UnmanagedCallersOnly]
        private static void SetDatavf(void* inrefcon, float* invalues, int inoffset, int incount)
        {
            var obj = Utils.TryGetObject<DataRefSource>(inrefcon);
            if (obj != null)
            {
        ...
        [UnmanagedCallersOnly]
        private static int GetDatab(void* inrefcon, void* outvalues, int inoffset, int inmax)
        {
            var obj = Utils.TryGetObject<DataRefSource>(inrefcon);
            if (obj != null)
            {
        ...
        [UnmanagedCallersOnly]
        private static void SetDatab(void* inrefcon, void* invalues, int inoffset, int incount)
        {
            var obj = Utils.TryGetObject<DataRefSource>(inrefcon);
            if (obj != null)
            {
    ...
    {
        protected DataRefSource(in Utf8String name, DataTypeID dataTypes, bool isWriteable) : base(name, dataTypes, isWriteable)
        {
        }

        protected DataRefSource(in ReadOnlySpan<char> name, DataTypeID dataTypes, bool isWriteable) : base(name, dataTypes, isWriteable)
        {
        }
